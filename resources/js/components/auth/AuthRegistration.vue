    ...
    <div class="bg-white font-family-karla h-screen">
        <div class="w-full flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                ...
                <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                    ...
                    <form @submit.prevent="submit"  method="POST" class="flex flex-col pt-3 md:pt-8">
                        <div class="flex flex-col pt-4">
                            ...
                            <input v-model='user.email'
                                   :class="{ 'border-gray-200': !errors.email, 'border-red': errors.email }"
                                   type="email"
                                   name="email"
                        ...
                        <div class="flex flex-col pt-4">
                            ...
                            <input v-model='user.name'
                                   :class="{ 'border-gray-200': !errors.name, 'border-red': errors.name }"
                                   type="text"
                                   name="name"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                            >
                        ...
                        <div class="flex flex-col pt-4">
                            ...
                            <input v-model='user.password'
                                   :class="{ 'border-gray-200': !errors.password, 'border-red': errors.password }"
                                   type="password"
                                   name="password"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                            >
                    ...
                    <div class="text-center pt-12 pb-12">
                        <p>
                            Уже есть аккаунт?
                            <router-link class="text-hookers-green underline font-semibold hover:text-dark-slate-gray" to="login">
                                Войти
                            </router-link>
                        </p>
                    </div>
            ...
            <div class="w-1/2 shadow-2xl">
                <img class="object-cover w-full h-screen hidden md:block" src="/imgs/registration.svg" alt="Регистрация">
            </div>
        </div>
    </div>
